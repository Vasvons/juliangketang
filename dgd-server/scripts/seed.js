...
async function seed() {
  ...
  try {
    ...
    console.log('插入课程资源...');
    await connection.query(
      'INSERT INTO courses (title, cover, category_id, description, catalog, netdisk_link, netdisk_code, publish_date, status, level_required, sort_order) VALUES ?',
      [
        [
          [
            '抖音小店从0到1实战课',
          ...
          [
            ...
            '社群拉新、活跃、转化、复购的标准化流程。',
            '第一章 社群定位\n第二章 拉新玩法\n第三章 日常活跃\n第四章 转化复购',
            'https://pan.baidu.com/s/1example5',
            'qrst',
            '2024-04-01',
            'published',
            null,
          ...
          [
            ...
            '一篇内容多平台分发，提升曝光效率。',
            '第一节 平台规则\n第二节 内容适配\n第三节 数据分析',
            'https://pan.baidu.com/s/1example6',
            'uvwx',
            '2024-04-15',
            'published',
            null,
          ...
          [
            ...
            '零基础学习手机拍摄与剪映剪辑。',
            '第一章 拍摄基础\n第二章 运镜技巧\n第三章 剪映实操',
            'https://pan.baidu.com/s/1example7',
            'yz12',
            '2024-05-01',
            'published',
            null,
          ...
          [
            ...
            '资料一 选品表\n资料二 话术库\n资料三 数据报表模板',
            'https://pan.baidu.com/s/1example8',
            '3456',
            '2024-05-10',
            'published',
            null,
          ...
          [
            ...
            '第一章 推荐算法\n第二章 账号标签\n第三章 内容模型\n第四章 数据分析',
            'https://pan.baidu.com/s/1example9',
            '7890',
            '2024-05-20',
            'published',
            2,
          ...
          [
            ...
            '第一节 人设打造\n第二节 朋友圈布局\n第三节 成交话术\n第四节 复购裂变',
            'https://pan.baidu.com/s/1example10',
            'abcd',
            '2024-06-01',
            'published',
            2,
