...
CREATE TABLE courses (
  ...
  netdisk_link VARCHAR(500) DEFAULT NULL COMMENT '网盘链接（已废弃，保留兼容）',
  netdisk_code VARCHAR(20) DEFAULT NULL COMMENT '网盘提取码（已废弃，保留兼容）',
  netdisk_resource TEXT COMMENT '网盘资源完整文本',
